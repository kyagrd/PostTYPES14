...
\newcommand{\InC}[1]{\ensuremath{\textbf{\textit{In}}^{c}_{#1}}}
\newcommand{\unInC}[1]{\ensuremath{\textbf{\textit{In}}^{\!c\,-\!1}_{#1}}}
...
%%% TODO Matthes PTCS 01 paper. factoring or deriving In' for generic F
...
\lstinputlisting[
	caption={List length example using \lstinline{mcata0} \label{lst:TODO}},
	firstline=3]{Rec2.hs}
